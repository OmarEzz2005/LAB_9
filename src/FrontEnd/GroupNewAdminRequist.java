 ...
 * @author yaseen
 */
public class GroupNewAdminRequist extends javax.swing.JPanel {

    /**
     * Creates new form NewAdminRequist
     */
    public GroupNewAdminRequist(String username) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            if (username.equals("No requests")) {
                JOptionPane.showMessageDialog(null, "No admin to accipt !!", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            LOGIN.groupdatabase.getRecord(Newsfeed.groupC).getOtherAdmins().add(username);
            LOGIN.groupdatabase.getRecord(Newsfeed.groupC).getNewAdminsreq().remove(username);
            ...
            JOptionPane.showMessageDialog(null, "You have acepted a new admin", "Success", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            if (username.equals("No requests")) {
                JOptionPane.showMessageDialog(null, "No admin to delete !!", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            LOGIN.groupdatabase.getRecord(Newsfeed.groupC).getNewAdminsreq().remove(username);
            LOGIN.groupdatabase.saveToFile();
            ...
            // Show success message
            JOptionPane.showMessageDialog(null, "You have deleted an admin", "Success", JOptionPane.INFORMATION_MESSAGE);
        }
